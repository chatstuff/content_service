...
database_name = case Padrino.env
  when :development then 'content_service_development'
  when :production  then 'content_service_production'
  when :test        then 'content_service_test'
end
...
#     sessions:
#       default:
#         database: content_service_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: content_service_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: content_service_test
#         hosts:
#           - localhost:27017
#
#
